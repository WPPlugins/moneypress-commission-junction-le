...
* 
************************************************************************/
define('WPCSL__mpcj__VERSION', '1.4.12');
...
class wpCSL_plugin__mpcj {
    ...
    function create_helper($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_helper__mpcj':
            case 'default':
            default:
                $this->helper = new wpCSL_helper__mpcj($this->helper_config);
    ...
    function create_notifications($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_notifications__mpcj':
            case 'default':
            default:
                $this->notifications = 
                    new wpCSL_notifications__mpcj($this->notifications_config);
        }
    }
    ...
    function create_products($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_products__mpcj':
            case 'default':
            default:
                $this->products = new wpCSL_products__mpcj($this->products_config);
    ...
    function create_settings($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_settings__mpcj':
            case 'default':
            default:
                $this->settings = new wpCSL_settings__mpcj($this->settings_config);
    ...
    function create_themes($class = 'none') {
        switch ($class) {
            ...
            case 'default':
            default:
                $this->themes = new wpCSL_themes__mpcj($this->themes_config);
    ...
    function create_license($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_license__mpcj':
            case 'default':
            default:
                if (!$this->no_license) {
                    $this->license = new wpCSL_license__mpcj($this->license_config);
                }
    ...
    function create_cache($class = 'none') {
        switch ($class) {
            ...
            case 'wpCSL_cache__mpcj':
            case 'default':
            default:
                $this->cache = new wpCSL_cache__mpcj($this->cache_config);
